...
namespace Problem27
{
    class Problem27
    {
        ...
        // From my testing you get a large performance boost by writing your own while loop through the primes array, rather than using Contains. I haven't been able to find the Contains source code in the 
        // CoreFX project yet, it's possible that it hasn't been open sourced yet, but I would love to know why. From my testing I saw a performance gain of ~1.5 seconds to the algorithm which is crazy
        // in terms of performance gain.
        public static bool IsPrime(int testNumber)
        {
            int i = 0;
            while (_primes[i] <= testNumber)
            {
                if (_primes[i] == testNumber)
                {
                    return true;
                }
                i++;
